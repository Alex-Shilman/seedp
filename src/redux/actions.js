...
export const NOTIFICATION_BANNER    = 'NOTIFICATION_BANNER';

export const loadData = ({params = {}} = {}) => {
  return dispatch => {
    dispatch({ type: LOAD_DATA_REQUEST });
    JsonRPC('/rpc/data_platform', { ...params, method: 'getDataPlatform' }).then(({ data }) =>
      dispatch({
...
export const loadDataUpdate = (payload) => {
  return {
