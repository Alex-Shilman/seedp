    ...
    return(
      <div className="PipeIcons">
        <svg id="arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 196 81.13">
          ...
          <ellipse class="pipe-ellipse" cx="181" cy="40.64" rx="12" ry="37.5" />
          <path class="pipe-outline" d="M371.09,169.6h0v-0.14h-165v0.28a4,4,0,0,0-1-.14c-6.63,0-12,16.79-12,37.5s5.37,37.5,12,37.5a4,4,0,0,0,1-.14v0.14h165c6.63,0,12-16.79,12-37.5S377.71,169.6,371.09,169.6Z" transform="translate(-190.09 -166.46)" />
        </svg>
      </div>
    );
  }
