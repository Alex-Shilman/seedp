    ...
    return(
      <div className="serverIcons">
        <svg id="arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70.81 76.98">
          ...
          <path className="connect-outline" d="M327.88,210.76H277.24L257.1,227.54h0v29.87h48.66l22.15-19.25v-27.4Zm-48.7,5.37h37.67l-13.13,11.41H265.49ZM262.43,252V232.91H302V252h-39.6Zm45-3.2V231.49l15.1-12.59v16.82Z" transform="translate(-257.06 -195.27)" />
