    ...
    return(
      <div className="serverIcons">
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 117.58 194.25">
            ...
            <path class="server-lines" d="M617.65,317.18v135H735.23v-135H617.65Zm108.25,9.33V363.1H627V326.52H725.9Zm0,41.25v36.17H627V367.76H725.9ZM627,442.84V408.6H725.9v34.24H627Z" transform="translate(-617.65 -287.19)" />
            <rect class="server-lines" x="15.17" y="55.49" width="65.62" height="4.67" />
            <rect class="server-lines" x="15.17" y="96.33" width="65.62" height="4.67" />
            <rect class="server-lines" x="15.17" y="137.16" width="65.62" height="4.67" />
            <circle class="server-lines" cx="95.13" cy="57.68" r="5.06" />
            <circle class="server-lines" cx="95.13" cy="98.52" r="5.06" />
            <circle class="server-lines" cx="95.13" cy="139.35" r="5.06" />
